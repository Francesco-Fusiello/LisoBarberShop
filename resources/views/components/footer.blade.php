  ...
  <div style="max-width:1200px; margin:auto; display:flex; flex-wrap:wrap; justify-content:space-between; gap:3rem;">
    ...
    <div style="flex:1 1 220px; min-width:180px; display:flex; flex-direction:column; align-items:center;">
      ...
      <div style="display:flex; gap:1.5rem;">
        ...
        <!-- Instagram -->
        <a href="https://www.instagram.com/lisobarbershop/" target="_blank" aria-label="Instagram" style="display:inline-block; width:36px; height:36px; transition: transform 0.3s ease;">
        ...
        <!-- Facebook -->
        <a href="https://www.facebook.com/lisogianfranco?locale=it_IT" target="_blank" aria-label="Facebook" style="display:inline-block; width:36px; height:36px; transition: transform 0.3s ease;">
        ...
        <!-- TikTok bianca -->
        <a href="https://www.tiktok.com/@lisobarbershop?lang=it" target="_blank" aria-label="TikTok" style="display:inline-block; width:36px; height:36px; transition: transform 0.3s ease;">
        ...
        <!-- Google -->
        <a href="https://www.google.com/search?sca_esv=c9f009eecb267ae2&sxsrf=AHTn8zpVG2CgZBNtbML3pfWfnl27GFSJtg:1741640347402&si=APYL9bs7Hg2KMLB-4tSoTdxuOx8BdRvHbByC_AuVpNyh0x2Kzd1p_qmCaJNYIVAz4f43GuI0eRBVK1vmnmioWmvZlK5oMwC3gK42j-FmM6ZirmEEh5ma4KAVowUTWYcyZKu7Bq1IG7FE&q=Liso+Barber+Recensioni&sa=X&ved=2ahUKEwi-1e7xs4CMAxUK_rsIHS2oOoMQ0bkNegQIIxAD&biw=1536&bih=738&dpr=1.25" target="_blank" aria-label="Google" style="display:inline-block; width:36px; height:36px; transition: transform 0.3s ease;">
