<footer style="background:#000; color:#D9C59B; padding:4rem 1rem; font-family: 'Lato', sans-serif; border-top:5px solid #000;">
  <div style="max-width:1200px; margin:auto; display:flex; flex-wrap:wrap; justify-content:space-between; gap:3rem;">
    ...
    <div style="flex:1 1 220px; min-width:180px; display:flex; flex-direction:column; align-items:center;">
      ...
      <div style="display:flex; gap:1.5rem;">
        ...
        <!-- Instagram -->
        <a href="https://www.instagram.com/lisobarbershop/" target="_blank" aria-label="Instagram" style="display:inline-block; width:36px; height:36px;">
        ...
        <!-- Facebook -->
        <a href="https://www.facebook.com/lisogianfranco?locale=it_IT" target="_blank" aria-label="Facebook" style="display:inline-block; width:36px; height:36px;">
