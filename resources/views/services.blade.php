            ...
            <div class="row align-items-center mb-5" data-aos="fade-up">
                <div class="col-md-6 mt-3 mt-md-0">
                    <img src="/images/services/taglioUomo.jpeg" class="img-fluid" 
                        alt="Taglio Uomo" loading="lazy" decoding="async">
                </div>
                <div class="col-md-6 d-flex">
                    <div class="text-box p-4 w-100" style="background-color: #fff;">
                        ...
                        <p style="color: #000;">
                            ...
                            personale. Attraverso una consulenza personalizzata, i nostri barbieri esperti realizzano tagli
                            classici o moderni, utilizzando tecniche avanzate per garantire precisione e durata nel tempo.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 d-flex">
                    <div class="text-box p-4 w-100" style="background-color: #fff;">
                        ...
                        <p style="color: #000;" id="modellatura-barba">
                            Prenditi cura della salute dei tuoi capelli con i nostri trattamenti specifici. Dalla ricostruzione
                ...
                <div class="col-md-6 d-flex">
                    <div class="text-box p-4 w-100" style="background-color: #fff;">
                        ...
                        <p style="color: #000;">
                            ...
                            pensato per offrire un'esperienza piacevole e divertente, con tagli moderni e adatti all'età.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 d-flex">
                    <div class="text-box p-4 w-100" style="background-color: #fff;">
                        ...
                        <p style="color: #000;" id="rasatura-tradizionale">
                            ...
                            una vasta gamma di tonalità, garantendo un risultato naturale e duraturo. Utilizziamo prodotti
            ...
            <div class="row align-items-center mb-5 flex-md-row-reverse" data-aos="fade-up">
                <div class="col-md-6 mt-3 mt-md-0">
                    <img src="/images/services/rasaturaTradizionale.jpeg" class="img-fluid" 
                        alt="Rasatura Tradizionale" loading="lazy" decoding="async">
                </div>
                <div class="col-md-6 d-flex">
                    <div class="text-box p-4 w-100" style="background-color: #fff;">
                        <h3 class="mb-3 pt-1" style="color: #000; font-family: 'Playfair Display', serif;">
            ...
            <div style="display: flex; justify-content: center; align-items: center; gap: 20px; flex-wrap: wrap; margin-top: 20px;">
                <a href="https://apps.apple.com/it/app/liso-barber-shop/id6502577739" target="_blank">
                    <img src="https://tools.applemediaservices.com/api/badges/download-on-the-app-store/black/it-it?size=250x83"
                        alt="Scarica su App Store" style="height: 60px; max-width: 100%;" loading="lazy" decoding="async">
                </a>
                <a href="https://play.google.com/store/search?q=liso+barber+shop&c=apps&hl=it" target="_blank">
                    <img src="https://play.google.com/intl/en_us/badges/static/images/badges/it_badge_web_generic.png"
                        alt="Disponibile su Google Play" style="height: 74.5px; max-width: 100%;" loading="lazy" decoding="async">
                </a>
            </div>
        </div>
    </section>
