        ...
        <div class="container">
            ...
            <div class="row align-items-center mb-5" data-aos="fade-up">
                ...
                <div class="col-md-6 mt-3 mt-md-0">
                    <img src="/images/services/taglioUomo.jpeg" class="img-fluid" 
                        alt="Taglio Uomo">
                </div>
                ...
                <div class="col-md-6 d-flex">
                    <div class="text-box p-4 w-100" style="background-color: #fff;">
                        ...
                        <p style="color: #000;">
                            ...
                            personale.
                            Attraverso una consulenza personalizzata, i nostri barbieri esperti realizzano tagli
                            classici o moderni,
                            utilizzando tecniche avanzate per garantire precisione e durata nel tempo.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 d-flex">
                    <div class="text-box p-4 w-100" style="background-color: #fff;">
                        ...
                        <p style="color: #000;" id="modellatura-barba">
                            ...
                            Dalla ricostruzione alla detossinazione del cuoio capelluto, utilizziamo prodotti
                            professionali
                ...
                <div class="col-md-6 d-flex">
                    <div class="text-box p-4 w-100" style="background-color: #fff;">
                        ...
                        <p style="color: #000;">
                            ...
                            misura,
                            che include la definizione delle linee, la regolazione della lunghezza e trattamenti
                            specifici
                ...
                <div class="col-md-6 d-flex">
                    <div class="text-box p-4 w-100" style="background-color: #fff;">
                        ...
                        <p style="color: #000;" id="rasatura-tradizionale">
                            ...
                            garantendo un risultato naturale e duraturo. Utilizziamo prodotti senza ammoniaca per
                            rispettare la salute del capello.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center mb-5 flex-md-row-reverse" data-aos="fade-up">
                <!-- Immagine -->
                <div class="col-md-6 mt-3 mt-md-0">
                    <img src="/images/services/rasaturaTradizionale.jpeg" class="img-fluid" 
                ...
                <div class="col-md-6 d-flex">
                    <div class="text-box p-4 w-100" style="background-color: #fff;">
                        <h3 class="mb-3 pt-1" style="color: #000; font-family: 'Playfair Display', serif;">Rasatura
                            Tradizionale</h3>
                        <p style="color: #000;">
                            Riscopri il piacere della rasatura tradizionale con panno caldo. Un rituale che combina
                            relax e cura della pelle,
                            utilizzando prodotti di alta qualità per una rasatura profonda e confortevole. Ideale per
                            chi desidera un momento di benessere autentico.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <a href="https://apps.apple.com/it/app/liso-barber-shop/id6502577739" target="_blank">
                    <img src="https://tools.applemediaservices.com/api/badges/download-on-the-app-store/black/it-it?size=250x83"
                        alt="Scarica su App Store" style="height: 60px; max-width: 100%;">
                </a>
                ...
                <a href="https://play.google.com/store/search?q=liso+barber+shop&c=apps&hl=it" target="_blank">
                    <img src="https://play.google.com/intl/en_us/badges/static/images/badges/it_badge_web_generic.png"
                        alt="Disponibile su Google Play" style="height: 74.5px; max-width: 100%;">
                </a>
            </div>
        </div>
    </section>
