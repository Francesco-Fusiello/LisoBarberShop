<x-layout>
    ...
    <div class="d-flex justify-content-center gap-3 mt-4">
        <a href="{{ route('recensioni.form') }}" class="btn btn-outline-warning btn-lg"
            style="border-radius: 50px; font-weight: 700;">
            Aggiungi Recensione
        </a>
  
        <a href="{{ route('recensioni.index') }}" class="btn btn-warning btn-lg"
            style="border-radius: 50px; font-weight: 700;">
            Mostra Tutte
        </a>
    </div>
  ...
  {{-- Carosello Prodotti --}}
        <h2 class="text-center mb- display-4"
