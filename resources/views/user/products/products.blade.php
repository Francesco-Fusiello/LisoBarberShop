<x-layout>
    ...
    <div class="p-6 max-w-6xl mx-auto" x-data="productSearch({{ Illuminate\Support\Js::from($productsJson) }})">
        ...
        <template x-if="query.length > 0">
            <div class="container mb-3 text-center text-muted fst-italic">
                    ...
                    <div class="col-md-4 mb-4 d-flex">
                        <div class="card shadow-lg rounded border-0 w-100 d-flex flex-column" style="height: 100%;">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <p class="card-text text-muted flex-grow-1" x-text="truncate(product.description, 100)">
                                </p>
                                <div class="d-flex justify-content-between align-items-center mt-auto">
                                    <p class="card-text text-dark mb-0"><strong>€<span
                                                x-text="formatPrice(product.price)"></span></strong></p>
                                    <a :href="`/products/${product.id}`" class="btn btn-dark btn-sm"
                                        style="border-radius: 50px;">Visualizza</a>
                                </div>
                            </div>
                        </div>
                    </div>
